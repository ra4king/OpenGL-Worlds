...
public class BulletRenderer {
	...
	public BulletRenderer(BulletManager bulletManager) {
		...
		bulletProgram = new ShaderProgram(
			Utils.readFully(Resources.getInputStream("shaders/bullet.vert")),
	...
	public void render(
		Matrix4 projectionMatrix, MatrixStack modelViewMatrix, FrustumCulling culling, Bullet... bullets) {
	...
	private void render(
		Matrix4 projectionMatrix, MatrixStack modelViewMatrix, BulletVectorPair[] bullets, FrustumCulling culling) {
		if (bullets.length == 0) {
			return;
		}
	...
	private static class BulletVectorPair implements Comparable<BulletVectorPair> {
		Bullet bullet;
		Vector3 vector;
		...
		@Override
		public int compareTo(BulletVectorPair bvp) {
